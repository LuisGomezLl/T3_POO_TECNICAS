 ...
 * @author USER
 */
public class JFrame_EditorProducto extends javax.swing.JFrame {

    private Producto producto;
    private JFrame_PantallaListaProducto padre;
    
    
    public JFrame_EditorProducto(JFrame_PantallaListaProducto padre) {
        initComponents();
        this.padre=padre;
    }
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(this, "¿Deseas Guardar?")
            ...
            producto.setNombree(txtproducto.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_EditorProducto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_EditorProducto(new JFrame_PantallaListaProducto()).setVisible(true);
            }
        });
    }
